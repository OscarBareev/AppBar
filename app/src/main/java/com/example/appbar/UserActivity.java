...
import com.example.appbar.healthClasses.User;
    ...
    private void Init() {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || ageStr.isEmpty()) {
                    Toast.makeText(UserActivity.this, R.string.needData, Toast.LENGTH_LONG).show();
                } else {
                    ...
                    try {
                        ...
                        Toast.makeText(UserActivity.this, R.string.addCorrect, Toast.LENGTH_LONG).show();
                    }
                }
            }
        ...
        pressureBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UserActivity.this, PressureActivity.class);
